     ...
     <body>
          <table class="modal-content bg table table-condensed table-striped ">
               <tr id="ROW1"><td colspan="8">
                    <h3 style="font-weight: bold;">Task 1</h3>
                </td>
               </tr>
...
$sql = "SELECT d.department_id, d.department_name, d.manager_id, e.first_name 
FROM departments d 
...
<div class="signup-image">
          <a href="../../index.html#tutorials" style="font-size:20px"><button class= "btn btn-danger">Back to Website !!!</a></button>
        </div>
</body>
