        ...
        <div class="row">
            ...
            <form action=""  method="post"  enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="date" id="date"  placeholder="Enter Birthdate" >
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="passno" id="passno"  placeholder="Enter Passno" >
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="register" id="register"  placeholder="Enter Contact" >
...
<?php 
 ...
 {    
     ...
     if($fullnm!=="" && $firstnm!="" && $lastnm!="" && $email!="" && $pass!="" && $contact!="" &&$birth!="" && $gender!="" && $passno!="" && $registerby!="" && $status!="")
     {
